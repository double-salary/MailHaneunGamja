...
<div id="bookmark-container">
  ...
  <ul>
    {#each bookmarks as bookmark, id}
      <MutableTodo {bookmark} on:click={() => toggle(id)} />
    {/each}
  </ul>
</div>
