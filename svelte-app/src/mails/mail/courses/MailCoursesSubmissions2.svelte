<script>
    ...
    const exampleData = [
      '저번 자료를 제출하지 않아 이번에 함께 첨부합니다. 확인부탁드립니다.',
      '한글 파일이 제 pc에서 지원이 되지 않아 워드로 작성하여 제출합니다. 양해 부탁드립니다.',
      '최종 제출 자료 중 일부는 완성하지 못했습니다. 완성되는대로 늦게라도 제출하도록 하겠습니다.',
    ];
    ...
    <div class="mail__content">
      ...
      <div id="copy" class="mail__text">
        ...
        <div class="mail__example">
          ...
          <p
            placeholder="저번 자료를 제출하지 않아 이번에 함께 첨부합니다. 확인부탁드립니다."
            contenteditable="true"
