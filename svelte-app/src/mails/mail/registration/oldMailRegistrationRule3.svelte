<script>
  ...
  let max;
  const exampleData = {
    1: '제 전공에 배정된 수업이 다른 수업과 시간이 겹치게 되어서 그런데 타과 학생들에게 배정된 이 수업을 수강할 수 있을까요? 혹시 가능하다면 이 수업의 정원 외 수강신청을 받아 주실 수 있는지 여쭤보고 싶습니다! ',
    2: '2',
    3: '3',
  };
...
<div class="mail__wrapper">
  <div class="mail__content">
    ...
    <div class="mail__title">
      제목:
      <p>
        [<span placeholder="강의명" contenteditable="true" bind:innerHTML={className}></span>] 대체 과목 수강 가능 여부 문의드립니다.
      </p>
    </div>
    ...
    <div id="copy" class="mail__text">
      ...
      <div class="mail__example">
        ...
        <p
          placeholder="
          제 전공에 배정된 수업이 다른 수업과 시간이 겹치게 되어서 그런데 타과 학생들에게 배정된 이 수업을 수강할 수 있을까요? 
          혹시 가능하다면 이 수업의 정원 외 수강신청을 받아 주실 수 있는지 여쭤보고 싶습니다! 
          "
