<script>
    ...
    const exampleData = [
      ...
      '다름이 아니라 제가 3학년 2학기 교환학생을 계획중이라 다음 학기에 개설 되는 강의 중 대기화학개론 및 실습을 권장 학년에 비해 일찍 수강하고자 하는데, 학기 중 학습만으로는 따라가기 벅찰 수 있다고 생각되어 이번 방학 중 부족한 부분을 미리 보완하고 싶어 교수님의 조언을 구하고 싶습니다. 혹시 제가 방학 중 미리 공부할 수 있는 이론적/프로그래밍적 내용이 있을까요?',
      '다름이 아니라 제가 화학해양학실험실에서 인턴을 하며 방법론적인 부분에 관하여 흥미가 생겼고, 이번 학기에 교수님의 대학원 강좌인 해양학 세미나를 수강하고자 합니다. 학과 사무실에서 학부생 대학원 교과목 수강신청 승인 요청서를 제출하기 이전에 교수님께 수강 가능 여부를 여쭙고자 이렇게 메일 드리게 되었습니다.',
    ];
