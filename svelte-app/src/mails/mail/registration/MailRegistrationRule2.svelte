<script>
  ...
  let max;
  const exampleData = {
    1: '저는 현재 정보문화학의 "인터랙티브 미디어" 수업을 수강하면서 배운 아두이노에 대한 기초 지식이 있는 상태입니다. 제가 선수강 과목인 "정보문화기술입문" 을 수강하지 않은 채로 이 과목을 수강해도 지장이 없을지 여쭙고 싶습니다. 혹시 부족하다면 제가 어떤 방법으로 이를 극복할 수 있을지 방법을 제시해주신다면 더욱 감사할 것 같습니다.',
    2: '2',
    3: '3',
  };
...
<div class="mail__wrapper">
  <div class="mail__content">
    ...
    <div class="mail__title">
      제목:
      <p>
        [<span placeholder="강의명" contenteditable="true" bind:innerHTML={className}></span>] 정원 외 수강신청 관련 문의드립니다.
      </p>
    </div>
