<script>
    ...
    let max;
    const exampleData = {
      1: '이번 학기부터 이 강의에 경영학과 수강제한이 걸려서 첫째날 수강신청을 못하게 되었습니다. 저는 경영학과 부전공을 희망하고 있어 이번학기에 꼭 이 강의를 수강하고 싶습니다.',
      2: '2',
    };
  ...
  <div class="mail__wrapper">
    <div class="mail__content">
      ...
      <div id="copy" class="mail__text">
        ...
        하여 정원 외 수강신청을 받아주시는지 여쭙고자 메일을 보내게 되었습니다. 꼭 교수님의 수업을 수강하고 싶습니다.
        <br>
