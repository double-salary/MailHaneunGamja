<script>
  ...
  const exampleData = [
    '저는 웹 개발 동아리와 <정보문화기술입문> 팀프로젝트를 하면서 웹 개발 분야에 관심을 쌓게 되었고, 이 과목을 수강하면서 루비 온 레일즈를 활용한 웹 개발 지식을 쌓고자 하였습니다.',
    '저는 {} 분야에 {} 능력이 필수적이라고 생각되어 {} 학부 전공 신청을 고려하고 있습니다. 그래서 이번 학기에 {} 전공 탐색을 하고자 하는 목표를 세웠고, 이에 가장 근본이 되는 이 과목을 꼭 수강해야겠다고 생각하였습니다.',
    '제가 다음 학기에 취업을 하게 되어 이 과목을 수강하지 못하면 졸업을 못하는 상황에 놓이게 되었습니다. 수강 신청 실패로 인해 졸업 계획에 차질이 생긴다면 매우 아쉬울 것 같아 교수님께 간곡히 부탁드립니다. ',
  ];
