<script>
    ...
    const exampleData = [
      '다름이 아니라 2021-2학기에 교수님의 랩에서 인턴이 가능한지 여쭤보기 위해 연락 드렸습니다. 이런 저런 논문들을 읽으며 컴퓨팅, 그리고 대기 분야와 관련된 경험을 해보고 싶다는 생각을 했고, 여러 교수님들의 실험실 사이트를 둘러보며 예보분석응용 실험실에서 하는 연구에 대해 더욱 자세히 배워보고싶다는 생각이 들어 이렇게 메일 드리게 되었습니다.',
      '2',
    ];
    ...
    <div class="mail__content">
      ...
      <div id="copy" class="mail__text">
        ...
        <div class="mail__example">
            ...
            <p
              placeholder="
                다름이 아니라 2021-2학기에 교수님의 랩에서 인턴이 가능한지 여쭤보기 위해 연락 드렸습니다. 
                이런 저런 논문들을 읽으며 컴퓨팅, 그리고 대기 분야와 관련된 경험을 해보고 싶다는 생각을 했고, 여러 교수님들의 실험실 사이트를 둘러보며 
                예보분석응용 실험실에서 하는 연구에 대해 더욱 자세히 배워보고싶다는 생각이 들어 이렇게 메일 드리게 되었습니다.
              "
        ...
        꼭 다음학기에 교수님의 랩에서 인턴을 진행하며 여러가지 경험을 쌓고 많은 것을 배우고 싶습니다.
        <br>
